...
/**
 * @description: get方式获取数据 from: https://blog.csdn.net/weixin_44936331/article/details/111300480
 * @author: yghhz
 * @create: 2020-11-15 10:14
 **/
public class MultiThreadedGetDemo {
    private static final Logger LOGGER = Logger.getLogger(MultiThreadedGetDemo.class);
    //用户名
